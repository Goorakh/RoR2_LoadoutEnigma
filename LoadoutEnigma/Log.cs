...
namespace LoadoutEnigma
{
    internal static class Log
    {
        ...
        static Log()
        {
            ...
            {
                const string MOD_NAME = nameof(LoadoutEnigma) + @"\";
                ...
                {
                    UnityEngine.Debug.LogError($"[{LoadoutEnigmaPlugin.PluginName}] Logger failed to determine caller path prefix length");
                    return 0;
                }
            }
        }
